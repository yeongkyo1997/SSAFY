<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.List,com.ssafy.board.model.BoardDto,com.ssafy.board.dao.BoardDaoImpl"%>
<%
	...
	<script>
		...
		titles.forEach(function(title) {
			title.addEventListener("click", function() {
				...
				location.href = "/board/board/view.jsp?viewno="
		...
		document.querySelector("#btn-mv-register").addEventListener("click",
				function() {
					location.href = "/board/board/write.jsp";
				});
	</script>
</body>
</html>
