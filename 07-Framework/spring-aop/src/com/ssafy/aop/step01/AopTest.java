...
public class AopTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ApplicationContext context = new ClassPathXmlApplicationContext("com/ssafy/aop/step01/config/applicationContext.xml");

        BoardController boardController = context.getBean("boardController", BoardController.class); // Bean의 id를 이용해서 Bean을 가져온다.
