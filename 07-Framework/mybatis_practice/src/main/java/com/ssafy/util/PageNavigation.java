...
public class PageNavigation {
    ...
    public void makeNavigator() {
        ...
        if (totalPageCount < endPage) endPage = totalPageCount;
        ...
        builder.append("			</li> \n");
        builder.append("			<li class=\"page-item\" data-pg=\"").append(this.startRange ? 1 : (startPage - 1)).append("\"> \n");
        builder.append("				<a href=\"#\" class=\"page-link\">이전</a> \n");
        builder.append("			</li> \n");
        for (int i = startPage; i <= endPage; i++) {
            builder.append("			<li class=\"").append(currentPage == i ? "page-item active" : "page-item").append("\" data-pg=\"").append(i).append("\"><a href=\"#\" class=\"page-link\">").append(i).append("</a></li> \n");
        }
        builder.append("			<li class=\"page-item\" data-pg=\"").append(this.endRange ? endPage : (endPage + 1)).append("\"> \n");
