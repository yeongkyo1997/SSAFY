	...
	<div class="container p-4">
		...
		<form id="registForm" method="post" action="${root}/product">
			...
			<div class="form-group">
				<label for="productCode">고유번호</label> <input type="text" name="code"
					class="form-control" id="productCode" placeholder="고유번호 입력">
			</div>
			<div class="form-group">
				<label for="model">모델명</label> <input type="text" name="model"
